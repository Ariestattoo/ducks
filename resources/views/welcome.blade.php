                ...
                >
                    <v-flex xs12 sm4 class="my-3">
                        <div class="text-xs-center">
                            <h2 class="headline">Vuetify Template Running on Laravel 5.7 </h2>
                        </div>
                    </v-flex>
                </v-layout>
            </section>
            ...
            <section>
                <v-parallax src="/img/section.jpg" height="380">
                    <v-layout column align-center justify-center>
                        <h1 class="mb-2 display-1 text-xs-center">Duck Feeding Application</h1>
                        <div class="subheading mb-3 text-xs-center">Powered by Steve</div>
